		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Simple login form -->
                   	<form method="POST" action="<?php echo base_url('login/forgot_update_pass/'.$users->user_id)?>">
			    ...
			    $this->session->sess_destroy();
							...
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block">Update<i class="icon-circle-right2 position-right"></i></button>
							</div>
							<div class="text-center">
