		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Simple login form -->
                   	<form method="POST" action="<?php echo base_url('login/send_mail') ?>">

						<div class="panel panel-body login-form">

							<div class="text-center">
								<div style="border-radius: 50%;"><i><img width=100% src="<?php echo base_url('assets/images/logo.jpg') ?>" alt=""></i></div>
			    ...
			    $this->session->sess_destroy();
							...
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block">Send Reset Link <i class="icon-circle-right2 position-right"></i></button>
							</div>
							<div class="text-center">
