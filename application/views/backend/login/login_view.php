		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Simple login form -->
                   	<form method="POST" action="<?php echo site_url('login/authentication_process') ?>">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div style="border-radius: 50%;"><i><img src="<?php echo base_url('assets/images/logo.jpg') ?>" alt=""></i></div>
					...
					<div class="footer text-muted text-center">
						&copy; <?php echo date('Y'); ?>. by <a href="http://ginilab.com" target="_blank">Spice-Guru</a>
					</div>
					<!-- /footer -->
